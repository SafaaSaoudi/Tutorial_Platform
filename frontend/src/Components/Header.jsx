    ...
    <header className="header-global" id="home">
      <nav id="navbar-main" aria-label="Primary navigation" className="navbar navbar-main navbar-expand-lg navbar-theme-primary headroom navbar-light navbar-theme-secondary">
        <div className="container position-relative">
          ...
          <div className="navbar-collapse collapse mr-auto" id="navbar_global">
            ...
            <ul className="navbar-nav navbar-nav-hover align-items-lg-center">
                    ...
                    <li className="nav-item">
                        <a href="http://127.0.0.1:5173/#testimonials" className="nav-link">
                            Testimonials
                        </a>
                    </li>
                    <li className="nav-item">
                        <a href="http://127.0.0.1:5173/#faq" className="nav-link">
                            FAQ
                        </a>
                    </li>
                    <li className="nav-item">
                        <a href="http://127.0.0.1:5173/#download" className="nav-link">
                            Download
                        </a>
                    </li>
                </ul>
        ...
        <a href="http://127.0.0.1:5173/login" className="btn btn-outline-soft d-none d-md-inline mr-md-3 animate-up-2">Sign In</a>
                ...
                <a href="http://127.0.0.1:5173/SignUp" className="btn btn-md btn-tertiary text-white d-none d-md-inline animate-up-2">Sign Up</a>            <button className="navbar-toggler ml-2" type="button" data-toggle="collapse" data-target="#navbar_global" aria-controls="navbar_global" aria-expanded="false" aria-label="Toggle navigation">
